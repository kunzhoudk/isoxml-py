...
def test__merge_ext_content__when_not_inplace__expect_originals_unchanged():
    ...
    ext_ref = iso3.ExternalFileReference(
        filename="CTR1234", filetype=iso3.ExternalFileReferenceType.XML
    )
...
def test__merge_ext_content__when_inplace__expect_task_data_altered():
    ...
    ext_ref = iso4.ExternalFileReference(
        filename="CTR1234", filetype=iso4.ExternalFileReferenceType.XML
    )
